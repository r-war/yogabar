        ...
        <div class="fields_start">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" onkeypress="return alphaNum(event);" id="passno" name="passno"
                placeholder="Passport no">
            </div>
            <div class="form-group">
              <label for="date">Date of Expiry (6 month validity required for travel) </label>
              <input type="text" readonly="true" class="form-control mt_b" autocomplete="off" id="ExpirDt" placeholder="DD/MM/YYYY"
                name='ExpirDt' />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value='{$mailVal}' id="cemail" name='cemail' placeholder="Email">
            </div>
          </div>
