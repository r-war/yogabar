...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
	...
	<tr><td align="center" bgcolor="#fbfcfd">
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr><td align="center">
				<div style="line-height: 24px;">
					<a style="width:200px; padding: 15px;  font-size:18px;cursor: pointer; box-shadow:none; color: #fff; border-color: #37CF87; background-color: #37CF87; border-radius: 2px;text-decoration:none " href="http://yogabar.sg/web/active_register.php?sid='.$curSessionId.'" target="_blank" class="btn btn-danger block-center">
					    Activate Now
					</a>
				</div>
				 <div style="height: 60px; line-height: 60px; font-size: 10px;"></div>
