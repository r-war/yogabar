...
if(isset($_SESSION['OFFPACKID']) && (isset($_SESSION['CAT'])) )
{
   if($_SESSION['CAT']=='ev'  &&  $_SESSION['OFFPACKID']>0  )
   {
        $eventId=$_SESSION['OFFPACKID'];
...
elseif(isset($_POST))
{
     ...
     if(isset($_POST['hidid']) && isset($_POST['hidregid']) )
      {
        
        if( ($_POST['hidid'] !="" && $_POST['hidid']>0)  && $_POST['hidregid']>0   )
        { 

          $eventId=$_POST['hidid'];
          $reg_id=$_POST['hidregid'];
