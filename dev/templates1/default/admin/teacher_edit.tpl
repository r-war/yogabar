	    	...
	    	<form class="" id="myform" method="post" action="">
				<fieldset>					
					<p>
						...
						<input type="text" id="title" name="title" value="{$smarty.post.title|default:$teacher_rs.name}" class="required">
					</p>
					<p>
						<label for="txt_description">Description:</label>
						<textarea id="content" name="content">{$smarty.post.content|default:$teacher_rs.description}</textarea>
					</p>	
					<p>
						<label for="image">Is Active:</label>
						<input type="checkbox" id="is_active" {if $teacher_rs.is_active == 1}checked="checked"{/if} name="is_active">
					</p>				
					<p>
