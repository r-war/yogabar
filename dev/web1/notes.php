...
$GetVal=$resultChk->rows;
 ...
 $sql = "SELECT if(price>0 ,1,0) as paylink,price,events_name,id,name,description,is_active,DATE_FORMAT(event_date,'%d-%b-%Y') as event_date,created_at,updated_at FROM events order by id Desc";
 $result = $db->query($sql);
