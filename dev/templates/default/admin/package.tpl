	  ...
	  <div class="col-md-9 ">  	
	    <div id="animation" class="white-bg-admin" style='width:900px !important;'>
	    	...
	    	<div class="table-responsive">
                ...
                <td><a  lang='{$package['id']}' class='actdeact' >{if $package['active'] eq 1} Active {else} Deactive {/if} </a> </td> <td>  
{if $package['pak_Intervel_id'] eq 2 }
<a href="package_edit.php?id={$package['id']}" >Edit</a>
        {/if}  </td>
    <td>{if $package['pak_Intervel_id'] eq 2 }
<a  lang='{$package['id']}' class='actDel' >Delete</a>
        {/if}  </td>          
