...
<!--        	<h4>PRIVATE CLASS</h4>
	        <ul>
		       {foreach $private_rs as $key => $package} 
		        <li>
		          <input type="radio" name="amount" data-toggle="modal" data-target="#myModalNorm" id="pvt"  onclick="radioEvent('{$package['name']}' , this.value);" value="{$package['price']}" >
		          <span class="doller">$</span>{$package['name']}
		        </li>
		        {/foreach}
	        </ul>
          ...
          <!--       <h4>COMBO PACKAGE</h4>
	        <ul>
		       {foreach $combo_rs as $key => $package} 
		        <li>
		          <input type="radio" name="amount" data-toggle="modal" data-target="#myModalNorm" id="pvt"  onclick="radioEvent('{$package['name']}' , this.value);" value="{$package['price']}" >
		          <span class="doller">$</span>{$package['name']}
		        </li>
	        ...
	        <ul>
		       {foreach $yy_rs as $key => $package} 
		        <li>
		          <input type="radio" name="amount" id="amt" data-toggle="modal" data-target="#myModalNorm" onClick="radioEvent('{$package['name']}' , this.value);" value="{$package['price']}" >
		          <span class="doller">$</span>{$package['name']}
		        </li>
		        {/foreach}
	        </ul>
