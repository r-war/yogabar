...
<div class="row">
 ...
 {/if}
<button  type="button" class="btn btn-primary center-block btn-md" lang='0' id='sbtn'><span  style="padding-right:2px;font-size: 20px;color:885630 " >&#36;</span>{$package['price']} {$package['pak_Intervel_id']}</button><br><span id='ldimg' style='display:none;'><image src='images/loadingImg.gif'></span> 
    {/foreach} 
<br>
 <span id='ErrMsg'>    </span>
<br>
