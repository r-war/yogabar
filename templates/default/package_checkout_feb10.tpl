...
<div class="package2">
   ...
   <div class="pheader2">
       <h4 class="text-center">Package Subscription</h4>
   </div>
<div class="pbody">
 ...
 {foreach $getAllSubunSubList as $key => $package}
<button  type="button" class="btn btn-primary center-block btn-md" id='sbtn'><span  style="padding-right:2px;font-size: 20px;color:885630 " >&#36;</span>{$package['price']} Suscribe</button><br><span id='ldimg' style='display:none;'><image src='images/loadingImg.gif'></span> 
    {/foreach} 
<br>
 <span id='ErrMsg'>    </span>
<br>
