    ...
    <div class="navbar-collapse collapse ">
      ...
      <ul class="nav navbar-nav pull-right">
        ...
        *}
        ...
        -->
        <li class="dropdown {$eventNt} ">
          <a href="profile.php" class="dropdown-toggle" data-toggle="dropdown"
            >Events <b class="caret"></b
          ></a>
          <ul class="dropdown-menu">
            <li class="{$eventWrk}"><a href="notes.php">Workshop</a></li>
            <li class="{$eventRe}"><a href="notes_re.php">Retreat</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown {$profile}">
          ...
          <ul class="dropdown-menu">
            <li class="{$profile}">
              <a href="profile.php">Profile({$smarty.session.UNAME})</a>
            </li>
            <li class="{$carddt}">
        ...
        <!--
          ...
          <li class="{$history}"><a href="user_pack.php">Payment history</a></li>
                 ...
                 <li class="{$loginout}"><a href="logout.php">Logout</a></li>
        -->
        {/if} {*if isset($smarty.session.UNAME)}
        <!--
