...
<body class="innerbg">
                ...
                <form id='packFrmC' name="packFrmC" method="post">
                    ...
                    <div class="package2">
                        ...
                        <div class="pbody">
                            ...
                            <input type='hidden' name='tblrow' id='tblrow' value="{$package['id']}">
                            ...
                            <div class="cards">
                                ...
                                {foreach $getAllSubunSubList as $key => $package}
                                {if $package['pak_Intervel_id']=='Pay'}
   ...
   <input type='text' name='cCode' id='cCode' style="width: 200px"><span class="input-group-addon" id="basic-addon2"><button  type="button"   id='vryfyCpn'>Verify coupon</button> </span>
                                ...
                                <button type="button" class="btn btn-primary center-block btn-md" lang='0' id='sbtn'><span
                                        style="padding-right:2px;font-size: 20px;color:885630 ">&#36;</span>{$package['price']}
                                    {$package['pak_Intervel_id']}</button><br><span id='ldimg' style='display:none;'>
