    ...
    <div class="container">
      ...
      {$events.description} -->
            ...
            <form name='reg' method='post' id='reg'>
                <input type='hidden' name="hididval" id="hididval" value="{$events.id}">
                <!-- <p>
              <input type="text" autofocus  name="uname"   value='{$name}' placeholder="Name" class="form-control" id="uname">
                ...
                <div class="reg_grey_block">
                    <h2 class="text-center">{$events.description}
                ...
                <div class="fields_start">
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value='{$unameVal}' name='fname' id="fname" placeholder="Name">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="fullname">Full Name (According to Passport):</label>
                            <input type="text" class="form-control" value='{$unameVal}' name='fname' id="fname"
                                placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="surname">Surname </label>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        {*<div class="form-group">
                            ...
                            <input type="text" onkeypress="return alphaNum(event);" class="form-control" id="passno"
                                name="passno" placeholder="Passport no">
                        </div>
                        <div class="form-group">
                            <label for="date">Date of Expiry (6 month validity required for travel) </label>
                            <input type="text" class="form-control mt_b" readonly="true" autocomplete="off" id="ExpirDt"
                                name='ExpirDt' placeholder="DD/MM/YYYY" <!-- <input type="text" class="form-control" id="surname"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value='{$mailVal}' id="cemail" name='cemail'
                                placeholder="Email">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
        ...
        <!-- <form action="login.php?p={$events.id}&ct=ev" id='evpackFrmL' name="evpackFrmL" method="post" > -->
