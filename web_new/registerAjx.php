...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
			    		<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; float:left; width:100%; padding:20px;text-align:center; font-size: 13px;">
									...
									<img src="http://dev.yogabar.sg/web/images/img_logo.png" width="120" alt="Yogabar" border="0"  /></font></a>
					</td>
					<td align="right">
	...
	<tr><td><a href='http://dev.yogabar.sg/web/active_register.php?sid=$curSessionId'>Click here  </td> </tr> 
	</table>";*/
    ...
    <div class="main_container" style="box-shadow: 0 0 5px #000;">
      ...
      <table class="in_container" border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
        <tr>
          ...
          <a href="http://dev.yogabar.sg/web/active_register.php?sid='.$curSessionId.'" style="width:200px; padding: 15px;  font-size:18px;
