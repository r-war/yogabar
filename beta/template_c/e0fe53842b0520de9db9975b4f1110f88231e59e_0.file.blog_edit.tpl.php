<?php /* Smarty version 3.1.27, created on 2015-10-13 20:46:01
         compiled from "/home/yogabar/public_html/beta/templates/default/admin/blog_edit.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:884118692561db3d9c44ab8_07947597%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0fe53842b0520de9db9975b4f1110f88231e59e' => 
    array (
      0 => '/home/yogabar/public_html/beta/templates/default/admin/blog_edit.tpl',
      1 => 1444782096,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '884118692561db3d9c44ab8_07947597',
  'variables' => 
  array (
    'blog_add' => 0,
    'blog_rs' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_561db3d9d000e8_08891824',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_561db3d9d000e8_08891824')) {
function content_561db3d9d000e8_08891824 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '884118692561db3d9c44ab8_07947597';
	    	...
	    	<form class="" id="myform" method="post" action="">
				<fieldset>					
					<p>
						...
						<input type="text" id="title" name="title" value="<?php echo (($tmp = @$_POST['title'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['blog_rs']->value['name'] : $tmp);?>
" class="required">
					</p>
					<p>
						<label for="txt_description">Description:</label>
						<textarea id="content" name="content"><?php echo (($tmp = @$_POST['content'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['blog_rs']->value['description'] : $tmp);?>
</textarea>
					</p>	
					<p>
						<label for="image">Is Active:</label>
						<input type="checkbox" id="is_active" <?php if ($_smarty_tpl->tpl_vars['blog_rs']->value['is_active'] == 1) {?>checked="checked"<?php }?> name="is_active">
					</p>				
					<p>
