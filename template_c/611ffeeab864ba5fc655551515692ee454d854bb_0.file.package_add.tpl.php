<?php /* Smarty version 3.1.27, created on 2017-09-20 06:21:28
         compiled from "/home/yogabar/public_html/templates/default/admin/package_add.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:183293377559c24f382caa09_35903716%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '183293377559c24f382caa09_35903716',
  'variables' => 
  array (
    'package_add' => 0,
    'PushSelecVal' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_59c24f383cab61_54368523',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_59c24f383cab61_54368523')) {
function content_59c24f383cab61_54368523 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '183293377559c24f382caa09_35903716';
	  ...
	  <div class="col-md-9 ">  	
	    <div id="animation" class="white-bg-admin">
	    	...
	    	<form class="" id="myform" method="post" action="">
				<fieldset>
				    <p>
						<label for="title">Package Stripe ID*:</label>
...
$('input[type=radio][name=group_type]').change(function() {
 var options = $("#totMon"); 
 $('#selIntr,#totMon').prop('disabled', false);
	if(this.value==4)
	{   
		 $('#selIntr').val(2);
	    options.empty();     
		...
		$("#totMon").val(1);
		$('#selIntr,#totMon').prop('disabled', true);
