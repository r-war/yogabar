<?php /* Smarty version 3.1.27, created on 2018-11-07 10:20:17
         compiled from "C:\xampp5\htdocs\yogabar\templates\default\package_checkout.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:308245be2ae51ef2536_37723367%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42797ac7ceb962016bed75464b3ca8e03be380db' => 
    array (
      0 => 'C:\\xampp5\\htdocs\\yogabar\\templates\\default\\package_checkout.tpl',
      1 => 1541582085,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '308245be2ae51ef2536_37723367',
  'variables' => 
  array (
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5be2ae5207b366_97444323',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5be2ae5207b366_97444323')) {
function content_5be2ae5207b366_97444323 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '308245be2ae51ef2536_37723367';
...
?>
   ...
   <input type='text' name='cCode' id='cCode' style="width: 200px"><span class="input-group-addon" id="basic-addon2"><button  type="button"   id='vryfyCpn'>Verify coupon</button> </span>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    ...
                                                    <span id='clrCupn' style="display:none;"><a href="" id='aclr' class="acard_detail">Clear
                                                            coupon code</a>
                                                    </span>
                                            </div>
                                        </div>
                                ...
                                <?php }?>
                                <button type="button" class="btn btn-primary center-block btn-md" lang='0' id='sbtn'><span
                                        style="padding-right:2px;font-size: 20px;color:885630 ">&#36;</span><?php echo $_smarty_tpl->tpl_vars['package']->value['price'];?>

                                    <?php echo $_smarty_tpl->tpl_vars['package']->value['pak_Intervel_id'];?>
</button><br><span id='ldimg' style='display:none;'>
                                    <image src='images/loadingImg.gif'>
                                </span>
                                <?php
$_smarty_tpl->tpl_vars['package'] = $foreach_package_Sav;
}
