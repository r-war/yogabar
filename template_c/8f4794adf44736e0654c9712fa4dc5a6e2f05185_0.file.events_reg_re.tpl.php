<?php /* Smarty version 3.1.27, created on 2018-11-10 04:32:52
         compiled from "C:\xampp5\htdocs\yogabar\templates\default\events_reg_re.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:32115be651644a32e1_47233038%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f4794adf44736e0654c9712fa4dc5a6e2f05185' => 
    array (
      0 => 'C:\\xampp5\\htdocs\\yogabar\\templates\\default\\events_reg_re.tpl',
      1 => 1541564900,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32115be651644a32e1_47233038',
  'variables' => 
  array (
    'events' => 0,
    'name' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5be651645faf32_94008807',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5be651645faf32_94008807')) {
function content_5be651645faf32_94008807 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '32115be651644a32e1_47233038';
...
' name='fname' id="fname"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" onkeypress="return alphaNum(event);" id="nirc" name='nirc'
                                placeholder="NIRC/FIN">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" onkeypress="return alphaNum(event);" id="passno"
                                name="passno" placeholder="Passport no">
                        </div>
                        <div class="form-group">
                            <label for="date">Date of Expiry (6 month validity required for travel) </label>
                            <input type="text" readonly="true" class="form-control mt_b" autocomplete="off" id="ExpirDt"
                                placeholder="DD/MM/YYYY" name='ExpirDt' />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly="true" id="dob" name='dob' placeholder="DD/MM/YYYY">
                        </div>
                        <div class="form-group">
        ...
        function validatePassword() {
            ...
            if (validator.form()) {
                ...
                $.ajax({
                    ...
                    data: $("#reg").serialize() + "&eveType=2",
                    success: function (data) {

                        /* below hide code for retreat Payment option hide by bala on Aug-18-2018 */

                        /* if($('#hideveprice').val()>0)
                         {
